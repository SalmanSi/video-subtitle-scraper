...
export default function SingleVideoIngestion() {
  ...
  const getVideoInfo = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE}/api/subtitles/info`, {
        video_url: videoUrl
      });
  ...
  const extractSubtitles = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE}/api/subtitles/extract`, {
        video_url: videoUrl,
  ...
  const downloadSubtitles = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE}/api/subtitles/extract/download`, {
        video_url: videoUrl,
        preferred_languages: preferredLanguages,
        include_auto_generated: includeAutoGenerated
      }, {
